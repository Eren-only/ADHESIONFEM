...
for K_off0 = 10 : 10 : lastKoff0
    ...
    %         fprintf(fid,'\r\n');
            ...
            if(t >= 8 && flag == 1)
                ...
                totalForce = totalForce + totalSpringForce;
    ...
    averNum = totalNum/1000;
    averForce = totalForce/1000;
    fprintf(fid,'\r\n');
    fprintf(fid,'平均');
    fprintf(fid,'%g\t',averNum);
    fprintf(fid,'%g\t',averForce);
    fprintf(fid,'\r\n');
    averNum = 0;
    averForce = 0;    
end
